...
@implementation Measurand
-(id)initWithDictionary:(NSDictionary*)initializers
{
    self.name=[initializers valueForKey:@"name"];
    self.value=[initializers valueForKey:@"value"];
    self.units=[self getUnits:self.name ];
...
-(NSDictionary*) getDictionary
{
    NSDictionary* map = [[NSDictionary alloc] initWithObjectsAndKeys:
                         ...
                         self.value ?: [NSNull null], @"value",
                         self.units ?: [NSNull null], @"units",
