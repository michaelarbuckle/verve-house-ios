...
{
    self.message=[initializers valueForKey:@"message"];
    self.topic = [initializers valueForKey:@"topic"];
    self.correlationId = [initializers valueForKey:@"correlationId"];
    self.author =  [initializers valueForKey:@"author"];
    self.type =  [initializers valueForKey:@"type"];
    self.level =  [initializers valueForKey:@"level"];
...
-(NSDictionary*) getDictionary
{
    NSDictionary* map = [[NSDictionary alloc] initWithObjectsAndKeys:
                         self.message ?: [NSNull null], @"message",
                         self.topic ?: [NSNull null], @"topic",
                         self.type ?: [NSNull null], @"type",
                         self.level ?: [NSNull null], @"level",
                         self.author ?: [NSNull null], @"author",
                         self.correlationId ?: [NSNull null], @"correlationId",
